...
//    private int port;
//
//    private final String SUBSCRIBE_ROOM_URL = "/user/topic/room";
//
...
//            stompSession.subscribe(SUBSCRIBE_ROOM_URL, new StompSessionHandlerAdapter() {
//                @Override
...
//            System.out.println("if stompSession.isConnected() ============================= " + stompSession.isConnected());
//
//        } else {
//            System.out.println("else stompSession.isClosed() ============================= ");
//        }
//
//
//        System.out.println("blockingQueue.isEmpty() " + blockingQueue.isEmpty());
